                            ...
                            <tbody>
                                ...
                                @foreach ($data as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <img height="70" id="myImg" src="{{ $data->ambilGambarMenu() }}" data-toggle="modal" data-target="#myModal"></img>
                                        </td>
                                        <td>{{ $data->harga }}</td>
                                        <td>{{ $data->diskon }}</td>
                                        <td>@foreach($data->kategori as $kategori)
                                                {{ $kategori->kategori->nama_kategori }} <br>
                                            @endforeach
                                        </td>
