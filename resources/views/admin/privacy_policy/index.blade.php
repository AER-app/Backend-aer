...
@section('content')
            ...
            <div class="row p-3">
                <div class="card col-12">
                    <div class="card-header">
                        <div class="section-title mt-0 mb-0">Privacy Policy</div>
    ...
    @include('admin.privacy_policy.edit')
    @include('admin.privacy_policy.tambah')
@endsection
@section('scripts')
    <script type="text/javascript">
        function deleteData(id) {
            var id = id;
            var url = '{{route("privacy_policy.destroy", ":id") }}';
    ...
    <script>
        $(document).ready(function() {
            ...
            table.on('click', '.edit', function() {
                ...
                console.log(data);
                $('#isi').val(data[1]);
                $('#editForm').attr('action', 'privacy_policy/' + data[2] );
